...
declare variable $index := doc("/db/apps/app-ct/data/indices/pedb.xml");
    ...
    where (($fromID eq "pe0313") or ($fromID eq "pe0232")) and (contains($toID, "pe0313") or (contains($toID, "pe0232")))
    return
    ...
    let $year := substring-before(data($doc//tei:correspAction[@type eq "sent"]/tei:date/@when), '-')
    let $date := if (data($doc//tei:correspAction[@type = "sent"]/tei:date/@when)) then ($year || ' ' || $month || ' ' || $day) else $doc//tei:date/string()
    where (($fromID eq "pe0228") or ($fromID eq "pe0232")) and (contains($toID, "pe0228") or (contains($toID, "pe0232")))
    return
    ...
    let $date := if (data($doc//tei:correspAction[@type = "sent"]/tei:date/@when)) then ($year || ' ' || $month || ' ' || $day) else $doc//tei:date/string()
    where ($fromID = "pe0408") or (contains($toID, "pe0408"))
    return
    ...
    let $year := substring-before(data($doc//tei:correspAction[@type = "sent"]/tei:date/@when), '-')
    let $date := if (data($doc//tei:correspAction[@type = "sent"]/tei:date/@when)) then ($year || ' ' || $month || ' ' || $day) else $doc//tei:date/string()
    where ($fromID = "pe0903") or (contains($toID, "pe0903"))
    return
    ...
    let $year := substring-before(data($doc//tei:correspAction[@type = "sent"]/tei:date/@when), '-')
    let $date := if (data($doc//tei:correspAction[@type = "sent"]/tei:date/@when)) then ($year || ' ' || $month || ' ' || $day) else $doc//tei:date/string()
    where ($fromID = "pe0803") or (contains($toID, "pe0803"))
    return
    ...
    let $year := substring-before(data($doc//tei:correspAction[@type = "sent"]/tei:date/@when), '-')
    let $date := if (data($doc//tei:correspAction[@type = "sent"]/tei:date/@when)) then ($year || ' ' || $month || ' ' || $day) else $doc//tei:date/string()
    where ($fromID = "pe0333") or (contains($toID, "pe0333"))
    return
